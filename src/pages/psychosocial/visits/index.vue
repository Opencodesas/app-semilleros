...
import TransversalActivity from '../transversal-activity/Index.vue';
...
const dataSearchTransversalActivities = computed(() =>
	searchData(transversalActivities.value, searchTransversalActivities.value)
);
		...
		<TabPanels>
			<TabPanel>
				<CommonInput
					...
					placeholder="Buscar" />
				<Crud
					:headers="headerVisits"
					:items="dataSearchVisits" />
			</TabPanel>
			<TabPanel>
				<CommonInput
					type="search"
					name="search"
					v-model="searchCustomVisits"
					placeholder="Buscar" />
				<Crud
					:headers="headerCustomVisits"
					:items="dataSearchCustomVisits" />
			</TabPanel>
			<TabPanel>
				<TransversalActivity />
			</TabPanel>
