...
<template>
   ...
   <div class="flex items-center justify-between mt-5 mb-2 intro-y">
      ...
      <span class="ml-auto text-base font-medium">
         Estado:
         <span
            v-if="currentUser.rol === 'metodologo'"
            :class="
         ...
         <span
            v-else-if="currentUser.rol === 'coordinador_regional'"
            :class="
               currentFicha.status.slug == 'REC'
                  ? ' bg-danger/10 text-danger'
                  : currentFicha.status.slug == 'APR'
   ...
   <div class="grid grid-cols-2 gap-6 justify-evenly">
      <div class="p-5 mt-5 col-span-2 intro-y box">
         ...
         <div class="mt-2 mb-5 col-span-2">
            <h3 v-if="currentFicha.revised_by">
               ...
               {{ currentFicha.revised_by.name }} el
               {{ currentFicha.revised_by.created_at }}
            </h3>
            <h3>
               <span class="font-bold">Monitor:</span>
               {{
                  currentFicha.created_by.name +
                  " " +
                  currentFicha.created_by.lastname
               }}
            </h3>
         </div>
      ...
      <div class="p-5 mt-5 col-span-2 intro-y box">
         ...
         <div
            class="mt-5 mb-3 grid grid-cols-1 md:grid md:grid-cols-2 gap-6 justify-evenly"
         >
            <CommonInput
