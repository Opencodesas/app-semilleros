...
const numbersToWords = (num: number) => {
    let data = {
        numero: num,
...
const Unidades = (num: number) => {
    ...
    return aLetras[num as keyof typeof aLetras] || ''
} // Unidades()
...
const Decenas = (num: number) => {
    ...
    const aLetras = {
        1: (() => {
            ...
            return aLetra[unidad as keyof typeof aLetra] || 'DIECI' + Unidades(unidad)
        })(),
    ...
    return aLetras[decena as keyof typeof aLetras] || ''
} //Decenas()
...
const Centenas = (num: number) => {
    ...
    return aLetras[centenas as keyof typeof aLetras] || Decenas(decenas)
} //Centenas()
